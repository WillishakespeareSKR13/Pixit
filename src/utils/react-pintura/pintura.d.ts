...
type ShapeSizeOption =
  | [number | Percentage, string]
  | [number | Percentage, string, any];
...
type StickerGroup =
  | [string, Sticker[]]
  | [string, Sticker[], StickerGroupOptions];
...
type ShapeTool =
  | [string, LocaleString]
  | [string, LocaleString, ShapeToolButtonOptions];
...
export const openDefaultEditor: (
  options: PinturaEditorDefaultOptions
) => PinturaEditorModal;
...
export const createDefaultImageReader: (
  options?: PinturaDefaultImageReaderOptions
) => any[];

export const createDefaultImageWriter: (
  options?: PinturaDefaultImageWriterOptions
) => any[];
 ...
 */
export const createMarkupEditorToolbar: (
  tools?: ToolbarItem[]
...
export const createMarkupEditorColorOptions: (
  colors: ColorPalette
) => ShapeColorOption[];
export const createMarkupEditorFontSizeOptions: (
  sizes: number[]
) => ShapeSizeOption[];
export const createMarkupEditorFontScaleOptions: (
  sizes: SizeCategories
) => ShapeSizeOption[];
export const createMarkupEditorStrokeWidthOptions: (
  widths: number[]
) => ShapeSizeOption[];
export const createMarkupEditorStrokeScaleOptions: (
  sizes: SizeCategories
) => ShapeSizeOption[];
...
export const createMarkupEditorStrokeWidthControl: (
  widths: ShapeSizeOption[]
) => ShapeControl;
...
export const createMarkupEditorFontStyleControl: (
  fontStyles: [string, string][]
) => ShapeControl;
export const createMarkupEditorFontSizeControl: (
  sizes: ShapeSizeOption[]
) => ShapeControl;
export const createMarkupEditorTextAlignControl: (
