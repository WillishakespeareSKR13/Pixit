...
export const AtomPdf = (props: AtomPdfProps) => {
  ...
  return (
    <NewDocument>
      <NewPage style={styles.page} size={'A3'}>
                  ...
                  <View key={color.value} style={styles.mainContainer}>
                    ...
                    >
                      <Image
                        src={
                          color?.img ??
                          'https://images.placeholders.dev/?width=300height=300&textColor=ffffff&bgColor=transparent'
                        }
                        style={{
                          width: '15px',
                          height: '15px'
      ...
      {images?.map((image, index) => (
        <NewPage key={`${index + 1}`} size="A3" style={styles.page}>
          <Image style={styles.ImageLogo} src="/images/logo.png" />
...
const DownloadPdf: FC<DocumentProps> = (props) => {
  ...
  return (
    <div>
      ...
      <PaymentModal {...payment} pdf={pdf} loading={loading} />
      {/* <PDFDownloadLink
        document={Document}
